...
--vcpus=${VCPUS} \
--os-type ${OS_TYPE} \
--disk path=/var/lib/libvirt/images/ol7.qcow2,size=${DISK_SIZE}  \
...
-x "ks=http://10.0.0.1/ol7/ol7.cfg ip=10.0.0.121::10.0.0.1:24:ol7::none nameserver=10.0.0.1 inst.sshd"
